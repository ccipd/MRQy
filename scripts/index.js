...
function reset_views_size () {
	...
	// 	if (CURRENT_DISPLAY_VIEWS.indexOf("table_meas") >= 0) {
	// 	if (CURRENT_DISPLAY_VIEWS.indexOf("chart") >= 0) {
	// 		if (CURRENT_DISPLAY_VIEWS.indexOf("image") >= 0) {
	// 			// all three
	// 			$("#table_meas-view").outerHeight(230);
	// 			$("#chart-view").outerHeight(330);
	// 		} else {
	// 			// table + chart
	// 			$("#table_meas-view").outerHeight(230);
	// 			$("#chart-view").outerHeight(total_height - $("#table_meas-view").outerHeight(includeMargin=true));
	// 		}
	// 	} else {
	// 		if (CURRENT_DISPLAY_VIEWS.indexOf("image") >= 0) {
	// 			// table + image
	...
	// 		} else {
	// 			// table
	// 			$("#table_meas-view").outerHeight(total_height);
	// 			$("#chart-view").outerHeight(0);
	// 		}
	// 	}
	// } else {
	...
	// 		if (CURRENT_DISPLAY_VIEWS.indexOf("image") >= 0) {
	// 			// chart + image
	// 			$("#table_meas-view").outerHeight(0);
	// 			$("#chart_meas-view").outerHeight(total_height * 0.4);
	// 		} else {
	// 			// chart
	// 			$("#table_meas-view").outerHeight(0);
	// 			$("#chart-view").outerHeight(total_height);
