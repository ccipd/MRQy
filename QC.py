...
if __name__ == '__main__':
    print('MRQy (New Version) is starting....')
    ...
    print("Done!")
    print("MRQy (New Version) program took", format((time.time() - start_time)/60, '.2f'), \
    ...
    print_msg_box(msg, indent=3, width=None, title="To view the final MRQy (New Version) interface results:")
