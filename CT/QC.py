# -*- coding: utf-8 -*-
"""
Created on Thu Sep  7 09:39:29 2023

@author:  Amir R. Sadri (ars329@case.edu)
"""
...
def volume_dicom(scans, name):
    ...
    first_row = {'Tag': 'Participant ID', 'Value': name}
...
if __name__ == '__main__':
    ...
    print("Done!")
    print("MRQy-CT program took", format((time.time() - start_time)/60, '.2f'), \
    ...
    print_msg_box(msg, indent=3, width=None, title="To view the final MRQy-CT interface results:")
